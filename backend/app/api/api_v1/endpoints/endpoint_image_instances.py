...
def read_image_instances(
    *,
    ...
    waiting_for_labels: Optional[bool] = False,
    ...
    Read list of image_instance metadata filtered by following options:
      ...
      - **waiting_for_labels** - returns image_instances that have been never annotated with labels
    ...
    if waiting_for_labels:
        query_out = query.image_instance.query_for_labeled(
            db, query_in=query_out, labeled=False
        )
