...
interface CreateLabelTaskFormParams {
...
const CreateLabelTaskForm = ({ annotators, selectedImages, gridApi, reloadImages }: CreateLabelTaskFormParams) => {
  ...
  const isFormValid = () => {
    if (taskName === undefined || taskName === '') {
      ...
      return false;
    } else if (selectedImages === undefined || selectedImages.length <= 0) {
      showDangerNotification(undefined, 'You have to choose at least one image!');
      return false;
    }
    return true;
  };
