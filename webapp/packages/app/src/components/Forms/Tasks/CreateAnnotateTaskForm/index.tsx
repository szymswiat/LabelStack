...
interface CreateAnnotateTaskFormParams {
...
const CreateAnnotateTaskForm = ({
  annotators,
  selectedLabelAssignments,
  gridApi,
  reloadLabelAssignments
}: CreateAnnotateTaskFormParams) => {
  ...
  const isFormValid = () => {
    if (taskName === undefined || taskName === '') {
      ...
      return false;
    } else if (selectedLabelAssignments === undefined || selectedLabelAssignments.length <= 0) {
      showDangerNotification(undefined, 'You have to choose at least one label assignment!');
      return false;
    }
    return true;
  };
